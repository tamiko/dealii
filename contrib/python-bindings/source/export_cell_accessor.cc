...
namespace python
{
  ...
  const char refine_flag_docstring[] = "Get/Set the refine_flag of the cell. In 2D, the possibilities are: \n"
                                       "  - isotropic                                                      \n"
                                       "  - no_refinement                                                  \n"
                                       "  - cut_x                                                          \n"
                                       "  - cut_y                                                          \n"
  ...
  const char set_all_manifold_ids_docstring[] = "Do as set_manifold_id() but also set the manifold indicators of    \n"
  ...
  const char center_docstring[] = "Center of the object. This method can take into account manifold   \n"
                                  "attached to a cell.                                                \n";
  ...
  const char has_boundary_lines_docstring[] = " This is a slight variation to the at_boundary function:           \n"
  ...
  const char vertex_index_docstring[] = " Return the global index of i-th vertex of a cell.                  \n";
  ...
  export_cell_accessor()
  {
    boost::python::class_<CellAccessorWrapper>("CellAccessor",
      ...
      .def("barycenter", &CellAccessorWrapper::get_barycenter, barycenter_docstring, boost::python::args("self"))
      .def("center",
      ...
      .def("get_vertex", &CellAccessorWrapper::get_vertex, get_vertex_docstring, boost::python::args("self", "i"))
      .def("at_boundary", &CellAccessorWrapper::at_boundary, at_boundary_docstring, boost::python::args("self"))
      .def("has_boundary_lines",
           &CellAccessorWrapper::has_boundary_lines,
           has_boundary_lines_docstring,
           boost::python::args("self"))
      .def("neighbor", &CellAccessorWrapper::neighbor, neighbor_docstring, boost::python::args("self", "i"))
      .def("faces", &CellAccessorWrapper::faces, faces_docstring, boost::python::args("self"))
      .def("measure", &CellAccessorWrapper::measure, measure_docstring, boost::python::args("self"))
      .def("active", &CellAccessorWrapper::active, active_docstring, boost::python::args("self"))
      .def("level", &CellAccessorWrapper::level, level_docstring, boost::python::args("self"))
      .def("index", &CellAccessorWrapper::index, index_docstring, boost::python::args("self"))
      ...
      .def("reference_cell",
           ...
           boost::python::args("self"))
      .def("n_vertices", &CellAccessorWrapper::n_vertices, n_vertices_docstring, boost::python::args("self"))
      .def("n_lines", &CellAccessorWrapper::n_lines, n_lines_docstring, boost::python::args("self"))
      .def("n_faces", &CellAccessorWrapper::n_faces, n_faces_docstring, boost::python::args("self"));
  }
} // namespace python

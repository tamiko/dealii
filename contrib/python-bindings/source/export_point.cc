...
namespace python
{
  const char to_list_docstring[] = "Convert point's coordinates to a python list with [x,y] or [x,y,z]     \n"
  ...
  export_point()
  {
    boost::python::class_<PointWrapper>("Point", boost::python::init<boost::python::list>())
      .def("to_list", &PointWrapper::to_list, to_list_docstring, boost::python::args("self"))
      .def("distance", &PointWrapper::distance, distance_docstring, boost::python::args("self", "p"))
      .def("norm", &PointWrapper::norm, norm_docstring, boost::python::args("self"))
      .def("norm_square", &PointWrapper::norm_square, norm_square_docstring, boost::python::args("self"))
      ...
      .def(boost::python::self *= float())
      .def(boost::python::self /= float())
      .add_property("x", &PointWrapper::get_x, &PointWrapper::set_x, get_x_docstring)
      .add_property("y", &PointWrapper::get_y, &PointWrapper::set_y, get_y_docstring)
      .add_property("z", &PointWrapper::get_z, &PointWrapper::set_z, get_z_docstring);
  }
} // namespace python

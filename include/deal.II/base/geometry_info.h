...
namespace internal
{
  namespace GeometryInfoHelper
  {
    ...
    struct Initializers<2>
    {
      ...
      unit_normal_vector()
      {
        return {{Tensor<1, 2>{{-1., 0.}}, Tensor<1, 2>{{1., 0.}}, Tensor<1, 2>{{0., -1.}}, Tensor<1, 2>{{0., 1.}}}};
      }
      ...
      {
        return {
          {{{Tensor<1, 2>{{0, -1}}}}, {{Tensor<1, 2>{{0, 1}}}}, {{Tensor<1, 2>{{1, 0}}}}, {{Tensor<1, 2>{{-1, 0}}}}}};
      }
    ...
    struct Initializers<4>
    {
      ...
      unit_tangential_vectors()
      {
        return {{{{Tensor<1, 4>{{0, -1, 0, 0}}, Tensor<1, 4>{{0, 0, 1, 0}}, Tensor<1, 4>{{0, 0, 0, 1}}}},
                 {{Tensor<1, 4>{{0, 1, 0, 0}}, Tensor<1, 4>{{0, 0, 1, 0}}, Tensor<1, 4>{{0, 0, 0, 1}}}},
                 {{Tensor<1, 4>{{0, 0, -1, 0}}, Tensor<1, 4>{{0, 0, 0, 1}}, Tensor<1, 4>{{1, 0, 0, 0}}}},
                 {{Tensor<1, 4>{{0, 0, 1, 0}}, Tensor<1, 4>{{0, 0, 0, 1}}, Tensor<1, 4>{{1, 0, 0, 0}}}},
                 {{Tensor<1, 4>{{0, 0, 0, -1}}, Tensor<1, 4>{{1, 0, 0, 0}}, Tensor<1, 4>{{0, 1, 0, 0}}}},
                 {{Tensor<1, 4>{{0, 0, 0, 1}}, Tensor<1, 4>{{1, 0, 0, 0}}, Tensor<1, 4>{{0, 1, 0, 0}}}},
                 {{Tensor<1, 4>{{-1, 0, 0, 0}}, Tensor<1, 4>{{0, 1, 0, 0}}, Tensor<1, 4>{{0, 0, 1, 0}}}},
                 {{Tensor<1, 4>{{1, 0, 0, 0}}, Tensor<1, 4>{{0, 1, 0, 0}}, Tensor<1, 4>{{0, 0, 1, 0}}}}}};
      }
...
struct GeometryInfo
{
   ...
   */
  static unsigned int
  standard_to_real_line_vertex(const unsigned int vertex, const bool line_orientation = true);
...
{
  template <int dim>
  inline SubfaceCase<dim>::SubfaceCase(const typename SubfacePossibilities<dim>::Possibilities subface_possibility)
...
RefinementCase<2>::cut_axis(const unsigned int i)
{
  ...
  const RefinementCase options[2] = {RefinementPossibilities<2>::cut_x, RefinementPossibilities<2>::cut_y};
  return options[i];
}
...
template <int dim>
inline RefinementCase<dim>::RefinementCase(const typename RefinementPossibilities<dim>::Possibilities refinement_case)
...
{
  return RefinementCase<dim>(static_cast<std::uint8_t>((~value) & RefinementPossibilities<dim>::isotropic_refinement));
}
...
GeometryInfo<3>::unit_cell_vertex(const unsigned int vertex)
{
  ...
  return {static_cast<double>(vertex % 2), static_cast<double>(vertex / 2 % 2), static_cast<double>(vertex / 4)};
}
                                              ...
                                              const bool         face_rotation)
{
  ...
  constexpr unsigned int vertex_translation[4][2][2][2] = {{{{0, 2}, // vertex 0, face_orientation=false,
                                                                     // face_flip=false, face_rotation=false and true
                                                             {3, 1}}, // vertex 0, face_orientation=false,
                                                                      // face_flip=true, face_rotation=false and true
                                                            {{0, 2}, // vertex 0, face_orientation=true,
                                                                     // face_flip=false, face_rotation=false and true
                                                             {3, 1}}}, // vertex 0, face_orientation=true,
                                                                       // face_flip=true, face_rotation=false and true
...
template <int dim>
inline unsigned int
GeometryInfo<dim>::standard_to_real_face_vertex(const unsigned int vertex, const bool, const bool, const bool)
{
...
{
  const unsigned int nsubs[internal::SubfaceCase<3>::case_isotropic + 1] = {0, 2, 3, 3, 4, 2, 3, 3, 4, 4};
...
template <>
inline double
GeometryInfo<3>::subface_ratio(const internal::SubfaceCase<3> &subface_case, const unsigned int subface_no)
{
  double ratio = 1;
  switch (subface_case)
    {
                                      ...
                                      const bool)
{
  ...
  AssertIndexRange(cell_refinement_case, RefinementCase<dim>::isotropic_refinement + 1);
...
template <>
inline RefinementCase<1>
GeometryInfo<1>::line_refinement_case(const RefinementCase<1> &cell_refinement_case, const unsigned int line_no)
{
  (void)line_no;
...
template <>
inline RefinementCase<1>
GeometryInfo<2>::line_refinement_case(const RefinementCase<2> &cell_refinement_case, const unsigned int line_no)
{
...
template <>
inline RefinementCase<1>
GeometryInfo<3>::line_refinement_case(const RefinementCase<3> &cell_refinement_case, const unsigned int line_no)
{
  const unsigned int dim = 3;
  AssertIndexRange(cell_refinement_case, RefinementCase<dim>::isotropic_refinement + 1);
  AssertIndexRange(line_no, GeometryInfo<dim>::lines_per_cell);
...
{
  const unsigned int dim = 2;
  AssertIndexRange(face_refinement_case, RefinementCase<dim - 1>::isotropic_refinement + 1);
  AssertIndexRange(face_no, GeometryInfo<dim>::faces_per_cell);

  if (face_refinement_case == RefinementCase<dim>::cut_x)
    return (face_no / 2) != 0u ? RefinementCase<dim>::cut_x : RefinementCase<dim>::cut_y;
  else
    return RefinementCase<dim>::no_refinement;
}
...
GeometryInfo<2>::min_cell_refinement_case_for_line_refinement(const unsigned int line_no)
{
  ...
  return (line_no / 2) != 0u ? RefinementCase<2>::cut_x : RefinementCase<2>::cut_y;
}
                                              ...
                                              const bool         face_rotation)
{
  ...
  const unsigned int vertex_translation[4][2][2][2] = {{{{0, 2},   // vertex 0, face_orientation=false, face_flip=false,
...
template <int dim>
inline unsigned int
GeometryInfo<dim>::real_to_standard_face_vertex(const unsigned int vertex, const bool, const bool, const bool)
{
  Assert(dim > 1, ExcImpossibleInDim(dim));
  AssertIndexRange(vertex, GeometryInfo<dim>::vertices_per_face);
  return vertex;
                                            ...
                                            const bool         face_rotation)
{
  ...
  const unsigned int line_translation[4][2][2][2] = {{{{2, 0},   // line 0, face_orientation=false, face_flip=false,
                                                                 // face_rotation=false and true
...
template <int dim>
inline unsigned int
GeometryInfo<dim>::standard_to_real_face_line(const unsigned int line, const bool, const bool, const bool)
{
  Assert(false, ExcNotImplemented());
  return line;
}
...
template <>
inline unsigned int
GeometryInfo<2>::standard_to_real_line_vertex(const unsigned int vertex, const bool line_orientation)
{
...
template <int dim>
inline unsigned int
GeometryInfo<dim>::standard_to_real_line_vertex(const unsigned int vertex, const bool)
{
  Assert(false, ExcNotImplemented());
  return vertex;
}
...
GeometryInfo<2>::standard_quad_vertex_to_line_vertex_index(const unsigned int vertex)
{
...
template <int dim>
inline std::array<unsigned int, 2>
GeometryInfo<dim>::standard_quad_vertex_to_line_vertex_index(const unsigned int vertex)
{
  Assert(false, ExcNotImplemented());
  (void)vertex;
  return {{0, 0}};
...
template <>
inline std::array<unsigned int, 2>
GeometryInfo<3>::standard_hex_vertex_to_quad_vertex_index(const unsigned int vertex)
{
...
template <int dim>
inline std::array<unsigned int, 2>
GeometryInfo<dim>::standard_hex_vertex_to_quad_vertex_index(const unsigned int vertex)
{
  Assert(false, ExcNotImplemented());
  (void)vertex;
  return {{0, 0}};
...
template <int dim>
inline unsigned int
GeometryInfo<dim>::real_to_standard_face_line(const unsigned int line, const bool, const bool, const bool)
{
  Assert(false, ExcNotImplemented());
  return line;
}
                                    ...
                                    const RefinementCase<1> &)
{
  ...
  const unsigned int subcells[2][RefinementCase<2>::isotropic_refinement][faces_per_cell][max_children_per_face] = {
    {
                                    ...
                                    const RefinementCase<2> &face_ref_case)
{
  ...
  AssertIndexRange(face, faces_per_cell);
  if (!(subface == 0 && face_ref_case == RefinementCase<dim - 1>::no_refinement))
    {
      AssertIndexRange(subface, GeometryInfo<dim - 1>::n_children(face_ref_case));
    }
  ...
  const unsigned int subface_exchange[4][2][2][2][4] = {// no_refinement (subface 0 stays 0,
  ...
  const unsigned int std_subface = subface_exchange[face_ref_case][face_orientation][face_flip][face_rotation][subface];
  ...
  const unsigned int iso_children[RefinementCase<dim>::cut_xyz][faces_per_cell][max_children_per_face] = {
    // cut_x
...
inline unsigned int
GeometryInfo<0>::face_to_cell_lines(const unsigned int, const unsigned int, const bool, const bool, const bool)
{
  Assert(false, ExcNotImplemented());
  return numbers::invalid_unsigned_int;
}
...
template <int dim>
inline unsigned int
GeometryInfo<dim>::face_to_cell_lines(const unsigned int, const unsigned int, const bool, const bool, const bool)
{
  Assert(false, ExcNotImplemented());
  return numbers::invalid_unsigned_int;
}
...
GeometryInfo<dim>::face_to_cell_vertices(const unsigned int face,
                                         ...
                                         const bool         face_rotation)
{
  return child_cell_on_face(
    RefinementCase<dim>::isotropic_refinement, face, vertex, face_orientation, face_flip, face_rotation);
}



inline unsigned int
GeometryInfo<0>::face_to_cell_vertices(const unsigned int, const unsigned int, const bool, const bool, const bool)
{
  Assert(false, ExcNotImplemented());
  return numbers::invalid_unsigned_int;
}
...
template <>
Tensor<1, 1> inline GeometryInfo<1>::d_linear_shape_function_gradient(const Point<1> &, const unsigned int i)
{
...
template <>
Tensor<1, 2> inline GeometryInfo<2>::d_linear_shape_function_gradient(const Point<2> &xi, const unsigned int i)
{
...
template <>
Tensor<1, 3> inline GeometryInfo<3>::d_linear_shape_function_gradient(const Point<3> &xi, const unsigned int i)
{
...
#  ifndef DEAL_II_CXX14_CONSTEXPR_BUG
  (const Point<spacedim> (&vertices)[vertices_per_cell], Tensor<spacedim - dim, spacedim> (&forms)[vertices_per_cell])
#  else
  (const Point<spacedim> *vertices, Tensor<spacedim - dim, spacedim> *forms)
#  endif
{
  ...
  for (unsigned int i = 0; i < vertices_per_cell; ++i)
    {
      ...
      for (unsigned int j = 0; j < vertices_per_cell; ++j)
        {
          const Tensor<1, dim> grad_phi_j = d_linear_shape_function_gradient(unit_cell_vertex(i), j);

...
namespace CGALWrappers
{
  ...
  void
  dealii_cell_to_cgal_surface_mesh(const typename dealii::Triangulation<dim, spacedim>::cell_iterator &cell,
  ...
  template <typename CGALPointType, int dim, int spacedim>
  void
  dealii_tria_to_cgal_surface_mesh(const dealii::Triangulation<dim, spacedim> &triangulation,
                                   CGAL::Surface_mesh<CGALPointType>          &mesh);
} // namespace CGALWrappers

...
public:
  ...
  public:
    ...
    using VectorizedArrayType =
      VectorizedArray<double, std::min<std::size_t>(VectorizedArray<double>::size(), (dim <= 2 ? 2 : 4))>;
     ...
     * transformations.
     */
    mutable internal::FEValuesImplementation::MappingRelatedData<dim, spacedim> *output_data;
  };

...
namespace GridTools
{
  ...
  private:
     ...
     * GridTools::vertex_to_cell_map()
     */
    mutable std::vector<std::set<typename Triangulation<dim, spacedim>::active_cell_iterator>> vertex_to_cells;
     ...
     * in input.
     */
    mutable std::map<unsigned int, RTree<std::pair<BoundingBox<spacedim>, unsigned int>>> covering_rtree;
     ...
     * triangulation.
     */
    mutable RTree<std::pair<BoundingBox<spacedim>, typename Triangulation<dim, spacedim>::active_cell_iterator>>
     ...
     */
    mutable std::map<unsigned int, std::set<dealii::types::subdomain_id>> vertices_with_ghost_neighbors;

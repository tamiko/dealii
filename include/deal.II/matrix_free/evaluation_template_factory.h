...
namespace internal
{
  ...
  struct FEEvaluationFactory
  {
    ...
    static bool
    fast_evaluation_supported(const unsigned int given_degree, const unsigned int n_q_points_1d);
  };
  ...
  struct CellwiseInverseMassFactory
  {
    ...
    static void
    transform_from_q_points_to_basis(const unsigned int                          n_components,
                                     const FEEvaluationData<dim, Number, false> &fe_eval,
                                     const Number                               *in_array,
                                     Number                                     *out_array);
  };

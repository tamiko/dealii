...
template <int dim>
double
ScalarLagrangePolynomialWedge<dim>::compute_value(const unsigned int i, const Point<dim> &p) const
{
...
template <int dim>
Tensor<1, dim>
ScalarLagrangePolynomialWedge<dim>::compute_grad(const unsigned int i, const Point<dim> &p) const
{
  const auto pair = this->degree() == 1 ? internal::wedge_table_1[i] : internal::wedge_table_2[i];
...
template <int dim>
Tensor<2, dim>
ScalarLagrangePolynomialWedge<dim>::compute_grad_grad(const unsigned int i, const Point<dim> &p) const
{
  (void)i;
  (void)p;
...
template <int dim>
void
ScalarLagrangePolynomialWedge<dim>::evaluate(const Point<dim>            &unit_point,
...
template <int dim>
Tensor<1, dim>
ScalarLagrangePolynomialWedge<dim>::compute_1st_derivative(const unsigned int i, const Point<dim> &p) const
{
...
template <int dim>
Tensor<2, dim>
ScalarLagrangePolynomialWedge<dim>::compute_2nd_derivative(const unsigned int i, const Point<dim> &p) const
{
  (void)i;
  (void)p;
...
template <int dim>
Tensor<3, dim>
ScalarLagrangePolynomialWedge<dim>::compute_3rd_derivative(const unsigned int i, const Point<dim> &p) const
{
  (void)i;
  (void)p;
...
template <int dim>
Tensor<4, dim>
ScalarLagrangePolynomialWedge<dim>::compute_4th_derivative(const unsigned int i, const Point<dim> &p) const
{
  (void)i;
  (void)p;

  ...
  dealii::internal::FEValuesImplementation::FiniteElementRelatedData<dim, spacedim> & /*output_data*/) const
{
  ...
  auto data_ptr         = std::make_unique<typename FiniteElement<dim, spacedim>::InternalDataBase>();
  ...
  dealii::internal::FEValuesImplementation::FiniteElementRelatedData<dim, spacedim> &output_data) const
{
  ...
  std::vector<double>         values((fe_internal.update_each & update_values) ? this->n_dofs_per_cell() : 0);
  std::vector<Tensor<1, dim>> grads((fe_internal.update_each & update_gradients) ? this->n_dofs_per_cell() : 0);
  std::vector<Tensor<2, dim>> grad_grads((fe_internal.update_each & update_hessians) ? this->n_dofs_per_cell() : 0);
...
template <int dim, int spacedim>
void
FE_DGPNonparametric<dim, spacedim>::get_face_interpolation_matrix(const FiniteElement<dim, spacedim> &x_source_fe,
...
template <int dim, int spacedim>
void
FE_DGPNonparametric<dim, spacedim>::get_subface_interpolation_matrix(const FiniteElement<dim, spacedim> &x_source_fe,
                                                                     const unsigned int,
                                                                     FullMatrix<double> &interpolation_matrix,
                                                                     const unsigned int) const
{
...
FE_DGPNonparametric<dim, spacedim>::hp_vertex_dof_identities(const FiniteElement<dim, spacedim> &fe_other) const
{
...
template <int dim, int spacedim>
std::vector<std::pair<unsigned int, unsigned int>>
FE_DGPNonparametric<dim, spacedim>::hp_line_dof_identities(const FiniteElement<dim, spacedim> &fe_other) const
{
  // there are no such constraints for DGPNonparametric
  // elements at all
  if (dynamic_cast<const FE_DGPNonparametric<dim, spacedim> *>(&fe_other) != nullptr)
...
template <int dim, int spacedim>
std::vector<std::pair<unsigned int, unsigned int>>
FE_DGPNonparametric<dim, spacedim>::hp_quad_dof_identities(const FiniteElement<dim, spacedim> &fe_other,
                                                           const unsigned int) const
{
  // there are no such constraints for DGPNonparametric
  // elements at all
...
FE_DGPNonparametric<dim, spacedim>::compare_for_domination(const FiniteElement<dim, spacedim> &fe_other,
...
template <int dim, int spacedim>
bool
FE_DGPNonparametric<dim, spacedim>::has_support_on_face(const unsigned int, const unsigned int) const
{
  return true;
}

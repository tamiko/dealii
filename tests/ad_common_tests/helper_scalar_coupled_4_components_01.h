...
struct FunctionsTestSymmetricTensorTensorVectorScalarCoupled
{
  ...
  {
    static const Tensor<2, dim, NumberType> I(unit_symmetric_tensor<dim, NumberType>());
    return 2.0 * I;
  }
  ...
  dpsi_dst(const SymmetricTensor<2, dim, NumberType> &st,
           ...
           const NumberType                          &s)
  {
    return 2.0 * pow(det_t(st), 1) * ddet_t_dt(st) * pow(det_t(t), 2) * pow(v_squ(v), 3) * pow(s, sf);
  };
  ...
  dpsi_dt(const SymmetricTensor<2, dim, NumberType> &st,
          ...
          const NumberType                          &s)
  {
    return 2.0 * pow(det_t(st), 2) * pow(det_t(t), 1) * ddet_t_dt(t) * pow(v_squ(v), 3) * pow(s, sf);
  };
  ...
  dpsi_dv(const SymmetricTensor<2, dim, NumberType> &st,
          ...
          const NumberType                          &s)
  {
    return pow(det_t(st), 2) * pow(det_t(t), 2) * 3.0 * pow(v_squ(v), 2) * dv_squ_dv(v) * pow(s, sf);
  };
  ...
  dpsi_ds(const SymmetricTensor<2, dim, NumberType> &st,
          ...
          const NumberType                          &s)
  {
    return pow(det_t(st), 2) * pow(det_t(t), 2) * pow(v_squ(v), 3) * sf * pow(s, sf - 1.0);
  };
                  ...
                  const NumberType                          &s)
  {
    return 2.0 * pow(det_t(t), 2) * pow(v_squ(v), 3) *
           (pow(det_t(st), 0) * outer_product(ddet_t_dt(st), ddet_t_dt(st)) + pow(det_t(st), 1) * d2det_t_dt_dt(st)) *
           pow(s, sf);
  };
                 ...
                 const NumberType                          &s)
  {
    return 4.0 * pow(det_t(st), 1) * pow(det_t(t), 1) *
           outer_product(Tensor<2, dim, NumberType>(ddet_t_dt(st)), ddet_t_dt(t)) * pow(v_squ(v), 3) * pow(s, sf);
  };
                 ...
                 const NumberType                          &s)
  {
    return 2.0 * pow(det_t(t), 2) * pow(det_t(st), 1) * 3.0 * pow(v_squ(v), 2) *
           outer_product(Tensor<2, dim, NumberType>(ddet_t_dt(st)), dv_squ_dv(v)) * pow(s, sf);
  };
  ...
  d2psi_dst_x_ds(const SymmetricTensor<2, dim, NumberType> &st,
                 ...
                 const NumberType                          &s)
  {
    return 2.0 * pow(det_t(st), 1) * ddet_t_dt(st) * pow(det_t(t), 2) * pow(v_squ(v), 3) * sf * pow(s, sf - 1.0);
  };
  ...
  {
    return 4.0 * pow(det_t(st), 1) * pow(det_t(t), 1) *
           outer_product(ddet_t_dt(t), Tensor<2, dim, NumberType>(ddet_t_dt(st))) * pow(v_squ(v), 3) * pow(s, sf);
  };
                ...
                const NumberType                          &s)
  {
    return 2.0 * pow(det_t(st), 2) * pow(v_squ(v), 3) *
           (pow(det_t(t), 0) * outer_product(ddet_t_dt(t), ddet_t_dt(t)) + pow(det_t(t), 1) * d2det_t_dt_dt(t)) *
           pow(s, sf);
  };
  ...
  d2psi_dt_x_ds(const SymmetricTensor<2, dim, NumberType> &st,
                ...
                const NumberType                          &s)
  {
    return 2.0 * pow(det_t(st), 2) * pow(det_t(t), 1) * ddet_t_dt(t) * pow(v_squ(v), 3) * sf * pow(s, sf - 1.0);
  };
  ...
  {
    return 2.0 * pow(det_t(t), 2) * pow(det_t(st), 1) * 3.0 * pow(v_squ(v), 2) *
           outer_product(dv_squ_dv(v), Tensor<2, dim, NumberType>(ddet_t_dt(st))) * pow(s, sf);
  };
                ...
                const NumberType                          &s)
  {
    return pow(det_t(st), 2) * pow(det_t(t), 2) * 3.0 *
           (2.0 * pow(v_squ(v), 1) * outer_product(dv_squ_dv(v), dv_squ_dv(v)) + pow(v_squ(v), 2) * d2v_squ_dv_dv(v)) *
           pow(s, sf);
  };
  ...
  d2psi_dv_x_ds(const SymmetricTensor<2, dim, NumberType> &st,
                ...
                const NumberType                          &s)
  {
    return pow(det_t(st), 2) * pow(det_t(t), 2) * 3.0 * pow(v_squ(v), 2) * dv_squ_dv(v) * sf * pow(s, sf - 1.0);
  };
  ...
  d2psi_ds_x_dst(const SymmetricTensor<2, dim, NumberType> &st,
                 ...
                 const NumberType                          &s)
  {
    return 2.0 * ddet_t_dt(st) * pow(det_t(t), 2) * pow(det_t(st), 1) * pow(v_squ(v), 3) * sf * pow(s, sf - 1.0);
  };
  ...
  d2psi_ds_x_ds(const SymmetricTensor<2, dim, NumberType> &st,
                ...
                const NumberType                          &s)
  {
    return pow(det_t(st), 2) * pow(det_t(t), 2) * pow(v_squ(v), 3) * sf * (sf - 1.0) * pow(s, sf - 2.0);
  };
};

template <int dim, typename NumberType>
const double FunctionsTestSymmetricTensorTensorVectorScalarCoupled<dim, NumberType>::sf = 2.2;
...
test_symmetric_tensor_tensor_vector_scalar_coupled()
{
  ...
  // Function and its derivatives
  using func_ad = FunctionsTestSymmetricTensorTensorVectorScalarCoupled<dim, ADNumberType>;

  // Setup the variable components and choose a value at which to
  // evaluate the tape
  const FEValuesExtractors::SymmetricTensor<2> st_dof(0);
  const FEValuesExtractors::Tensor<2>          t_dof(SymmetricTensor<2, dim>::n_independent_components);
  const FEValuesExtractors::Vector             v_dof(SymmetricTensor<2, dim>::n_independent_components +
                                         Tensor<2, dim>::n_independent_components);
  const FEValuesExtractors::Scalar             s_dof(SymmetricTensor<2, dim>::n_independent_components +
                                         Tensor<2, dim>::n_independent_components +
  ...
  SymmetricTensor<2, dim, ScalarNumberType> st = unit_symmetric_tensor<dim, ScalarNumberType>();
  ...
  if (is_recording == true)
    {
      ...
      const SymmetricTensor<2, dim, ADNumberType> st_ad = ad_helper.get_sensitive_variables(st_dof);
  ...
  const SymmetricTensor<2, dim, ScalarNumberType> dpsi_dst = ad_helper.extract_gradient_component(Dpsi, st_dof);
  ...
  const Tensor<0, dim, ScalarNumberType>          dpsi_ds  = ad_helper.extract_gradient_component(Dpsi, s_dof);
  ...
  // Verify the result
  using func                        = FunctionsTestSymmetricTensorTensorVectorScalarCoupled<dim, ScalarNumberType>;
  static const ScalarNumberType tol = 1e6 * std::numeric_limits<ScalarNumberType>::epsilon();
  Assert(std::abs(psi - func::psi(st, t, v, s)) < tol, ExcMessage("No match for function value."));
  Assert(std::abs((dpsi_dst - func::dpsi_dst(st, t, v, s)).norm()) < tol, ExcMessage("No match for first derivative."));
  Assert(std::abs((dpsi_dt - func::dpsi_dt(st, t, v, s)).norm()) < tol, ExcMessage("No match for first derivative."));
  Assert(std::abs((dpsi_dv - func::dpsi_dv(st, t, v, s)).norm()) < tol, ExcMessage("No match for first derivative."));
  Assert(std::abs(dpsi_ds - func::dpsi_ds(st, t, v, s)) < tol, ExcMessage("No match for first derivative."));

  if (AD::ADNumberTraits<ADNumberType>::n_supported_derivative_levels >= 2)
    {
      const SymmetricTensor<4, dim, ScalarNumberType> d2psi_dst_x_dst =
        ad_helper.extract_hessian_component(D2psi, st_dof, st_dof);
      const Tensor<4, dim, ScalarNumberType> d2psi_dst_x_dt = ad_helper.extract_hessian_component(D2psi, st_dof, t_dof);
      const Tensor<3, dim, ScalarNumberType> d2psi_dst_x_dv = ad_helper.extract_hessian_component(D2psi, st_dof, v_dof);
      const Tensor<2, dim, ScalarNumberType> d2psi_dst_x_ds = ad_helper.extract_hessian_component(D2psi, st_dof, s_dof);

      const Tensor<4, dim, ScalarNumberType> d2psi_dt_x_dst = ad_helper.extract_hessian_component(D2psi, t_dof, st_dof);
      const Tensor<4, dim, ScalarNumberType> d2psi_dt_x_dt  = ad_helper.extract_hessian_component(D2psi, t_dof, t_dof);
      const Tensor<3, dim, ScalarNumberType> d2psi_dt_x_dv  = ad_helper.extract_hessian_component(D2psi, t_dof, v_dof);
      const Tensor<2, dim, ScalarNumberType> d2psi_dt_x_ds  = ad_helper.extract_hessian_component(D2psi, t_dof, s_dof);

      const Tensor<3, dim, ScalarNumberType> d2psi_dv_x_dst = ad_helper.extract_hessian_component(D2psi, v_dof, st_dof);
      const Tensor<3, dim, ScalarNumberType> d2psi_dv_x_dt  = ad_helper.extract_hessian_component(D2psi, v_dof, t_dof);
      const Tensor<2, dim, ScalarNumberType> d2psi_dv_x_dv  = ad_helper.extract_hessian_component(D2psi, v_dof, v_dof);
      const Tensor<1, dim, ScalarNumberType> d2psi_dv_x_ds  = ad_helper.extract_hessian_component(D2psi, v_dof, s_dof);

      const SymmetricTensor<2, dim, ScalarNumberType> d2psi_ds_x_dst =
        ad_helper.extract_hessian_component(D2psi, s_dof, st_dof);
      const Tensor<2, dim, ScalarNumberType> d2psi_ds_x_dt = ad_helper.extract_hessian_component(D2psi, s_dof, t_dof);
      const Tensor<1, dim, ScalarNumberType> d2psi_ds_x_dv = ad_helper.extract_hessian_component(D2psi, s_dof, v_dof);
      const Tensor<0, dim, ScalarNumberType> d2psi_ds_x_ds = ad_helper.extract_hessian_component(D2psi, s_dof, s_dof);
      ...
      Assert(std::abs((d2psi_dst_x_dst - func::d2psi_dst_x_dst(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dst_x_dt - func::d2psi_dst_x_dt(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dst_x_dv - func::d2psi_dst_x_dv(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dst_x_ds - func::d2psi_dst_x_ds(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dt_x_dst - func::d2psi_dt_x_dst(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dt_x_dt - func::d2psi_dt_x_dt(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dt_x_dv - func::d2psi_dt_x_dv(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dt_x_ds - func::d2psi_dt_x_ds(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dv_x_dst - func::d2psi_dv_x_dst(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dv_x_dt - func::d2psi_dv_x_dt(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dv_x_dv - func::d2psi_dv_x_dv(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_dv_x_ds - func::d2psi_dv_x_ds(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_ds_x_dst - func::d2psi_ds_x_dst(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_ds_x_dt - func::d2psi_ds_x_dt(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));
      Assert(std::abs((d2psi_ds_x_dv - func::d2psi_ds_x_dv(st, t, v, s)).norm()) < tol,
             ExcMessage("No match for second derivative."));

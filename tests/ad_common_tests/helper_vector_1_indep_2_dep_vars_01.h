...
test_AD_vector_jacobian()
{
  ...
  std::cout << "funcs[0]: " << funcs[0] << "\t func::f0(s[0])): " << func::f0(s[0]) << std::endl;
  std::cout << "funcs[1]: " << funcs[1] << "\t func::f1(s[0])): " << func::f1(s[0]) << std::endl;
  std::cout << "Dfuncs[0][0]: " << Dfuncs[0][0] << "\t func::df0_ds0(s[0])): " << func::df0_ds0(s[0]) << std::endl;
  std::cout << "Dfuncs[1][0]: " << Dfuncs[1][0] << "\t func::df1_ds0(s[0])): " << func::df1_ds0(s[0]) << std::endl;
  Assert(std::abs(funcs[0] - func::f0(s[0])) < tol, ExcMessage("No match for function 1 value."));
  Assert(std::abs(funcs[1] - func::f1(s[0])) < tol, ExcMessage("No match for function 2 value."));
  Assert(std::abs(Dfuncs[0][0] - func::df0_ds0(s[0])) < tol, ExcMessage("No match for function 1 first derivative.."));
  Assert(std::abs(Dfuncs[1][0] - func::df1_ds0(s[0])) < tol, ExcMessage("No match for function 2 first derivative.."));
}

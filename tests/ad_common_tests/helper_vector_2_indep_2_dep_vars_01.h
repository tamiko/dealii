...
test_AD_vector_jacobian()
{
  ...
  std::cout << "funcs[1]: " << funcs[1] << "\t func::f1(s[0],s[1])): " << func::f1(s[0], s[1]) << std::endl;
  std::cout << "Dfuncs[0][0]: " << Dfuncs[0][0] << "\t func::df0_ds0(s[0],s[1])): " << func::df0_ds0(s[0], s[1])
            << std::endl;
  std::cout << "Dfuncs[0][1]: " << Dfuncs[0][1] << "\t func::df0_ds1(s[0],s[1])): " << func::df0_ds1(s[0], s[1])
            << std::endl;
  std::cout << "Dfuncs[1][0]: " << Dfuncs[1][0] << "\t func::df1_ds0(s[0],s[1])): " << func::df1_ds0(s[0], s[1])
            << std::endl;
  std::cout << "Dfuncs[1][1]: " << Dfuncs[1][1] << "\t func::df1_ds1(s[0],s[1])): " << func::df1_ds1(s[0], s[1])
            << std::endl;

...
main()
{
  ...
  deallog.push("Double");
  {
    test_symmetric_tensor_symmetric_tensor_coupled<2, double, AD::NumberTypes::adolc_taped>();
    test_symmetric_tensor_symmetric_tensor_coupled<3, double, AD::NumberTypes::adolc_taped>();
    deallog << "OK" << std::endl;
  }
  deallog.pop();

...
main(int argc, char **argv)
{
  ...
  deallog.push("Double");
  {
    test_symmetric_tensor_tensor_vector_scalar_coupled<2, double, AD::NumberTypes::adolc_taped>();
    test_symmetric_tensor_tensor_vector_scalar_coupled<3, double, AD::NumberTypes::adolc_taped>();
    deallog << "OK" << std::endl;
  }
  deallog.pop();

...
main()
{
  ...
  AssertThrow((test_register_multiple_dep_vars<dim, double, AD::NumberTypes::adolc_taped>() == expected_result),
              ExcInternalError());
  AssertThrow((test_register_multiple_dep_vars<dim, double, AD::NumberTypes::adolc_tapeless>() == expected_result),
              ExcInternalError());

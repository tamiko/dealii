...
check()
{
  ...
  deallog << is_finite(T(0, std::numeric_limits<typename numbers::NumberTraits<T>::real_type>::quiet_NaN()))
          << std::endl;
  ...
  deallog << is_finite(T(0, std::numeric_limits<typename numbers::NumberTraits<T>::real_type>::signaling_NaN()))
          << std::endl;
  ...
  deallog << is_finite(T(0, std::numeric_limits<typename numbers::NumberTraits<T>::real_type>::infinity()))
          << std::endl;

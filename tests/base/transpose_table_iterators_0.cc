...
main()
{
  ...
  // test some things with accessors
  {
    ...
    MatrixTableIterators::Accessor<TransposeTable<double>, true, MatrixTableIterators::Storage::column_major> a3(&table,
                                                                                                                 2);
    MatrixTableIterators::Accessor<TransposeTable<double>, false, MatrixTableIterators::Storage::column_major> a4(
      &table, 2);
    deallog
      << "Accessors refer to the same entry: "
      << (&(MatrixTableIterators::Accessor<TransposeTable<double>, true, MatrixTableIterators::Storage::column_major>(
              a4)
              .value()) == &(a3.value()))
      << std::endl;
  }

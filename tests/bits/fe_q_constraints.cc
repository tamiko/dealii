...
TestFEQConstraints<dim>::make_grid_and_dofs()
{
  ...
  deallog << "---------------------------------------------------------" << std::endl;
  deallog << "P-Order: " << p_order << "  Number of degrees of freedom: " << dof_handler.n_dofs() << std::endl;
...
TestFEQConstraints<dim>::test()
{
  ...
  VectorTools::integrate_difference(
    dof_handler, solution, Functions::ZeroFunction<dim>(1), norm_per_cell, quadrature, VectorTools::L2_norm);

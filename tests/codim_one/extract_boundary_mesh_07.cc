...
namespace Step38
{
  ...
  Extract_Mesh_Test<spacedim>::run()
  {
    ...
    std::map<typename DoFHandler<boundary_dim, spacedim>::cell_iterator, typename DoFHandler<spacedim>::face_iterator>
      element_assignment = GridGenerator::extract_boundary_mesh(space_dof_handler, contact_dof_handler, boundary_ids);

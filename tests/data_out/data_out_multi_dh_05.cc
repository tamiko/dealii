...
test()
{
  ...
  data_out.add_data_vector(dof2, v2, std::vector<std::string>(dim, "vector1"), component_interpretation);
  data_out.add_data_vector(dof1, v3, "scalar2");
  data_out.add_data_vector(dof2, v4, std::vector<std::string>(dim, "vector2"), component_interpretation);

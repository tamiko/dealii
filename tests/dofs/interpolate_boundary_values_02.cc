...
test()
{
  ...
  VectorTools::interpolate_boundary_values(dof_handler, 10, Functions::SquareFunction<dim>(), boundary_values);
  VectorTools::interpolate_boundary_values(dof_handler, 20, Functions::SquareFunction<dim>(), boundary_values);

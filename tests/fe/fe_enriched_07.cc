...
test6(const bool do_href, const unsigned int p_feq = 1, const unsigned int p_feen = 2)
{
  ...
  std::string filename = "hp-shape_functions_ref=" + std::to_string(do_href) + "_p_feq=" + std::to_string(p_feq) +
                         "_p_feenr=" + std::to_string(p_feen) + "_" + dealii::Utilities::int_to_string(dim) + "D.vtu";

...
void
print_dofs(const typename DoFHandler<1, spacedim>::face_iterator &i, const unsigned int fe_index, const unsigned int n)
{
...
template <int spacedim>
void
print_dofs(const typename DoFHandler<1, spacedim>::cell_iterator &i, const unsigned int n)
{
  std::vector<types::global_dof_index> dof_indices(n);

...
transfer(std::ostream &out)
{
  ...
  {
    typename DoFHandler<dim>::active_cell_iterator cell   = q_dof_handler.begin_active(),
  ...
  MyFunction<dim> func;
  {
    ...
    typename DoFHandler<dim>::active_cell_iterator cell = q_dof_handler.begin_active(), endc = q_dof_handler.end();
  ...
  }
  {
    ...
    std::vector<double>                            vals(quad[0].size());
    typename DoFHandler<dim>::active_cell_iterator celldg = dgq_dof_handler.begin_active(),

...
LaplaceProblem::assemble_system()
{
  ...
  hp::FEValues<2> x_fe_values(fe, quadrature_formula, update_values | update_gradients | update_JxW_values);
...
LaplaceProblem::run()
{
  FE_Q<2> fe_1(1), fe_2(2), fe_3(QIterated<1>(QTrapezoid<1>(), 3)), fe_4(QIterated<1>(QTrapezoid<1>(), 4)),
    fe_5(QIterated<1>(QTrapezoid<1>(), 5)), fe_6(QIterated<1>(QTrapezoid<1>(), 6));

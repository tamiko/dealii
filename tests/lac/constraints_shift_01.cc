...
test()
{
  ...
  deallog << "Create AffineConstraints<double> with constraints u(2)=.5*u(5), u(5)=.7*u(8)" << std::endl;
  ...
  constraints1.merge(constraints2, AffineConstraints<double>::no_conflicts_allowed, true);

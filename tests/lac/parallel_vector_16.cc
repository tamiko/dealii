...
test()
{
  ...
  Kokkos::View<double *, MemorySpace::Default::kokkos_space>       v_view(v.get_values(), local_relevant.n_elements());
  ...
  Kokkos::deep_copy(Kokkos::subview(v_view, partitioner->global_to_local(min_index + 42)),

...
main()
{
  ...
  deallog << "has_add_local_element:" << std::endl
          << "Dummy = " << internal::has_add_local_element<Dummy<double>> << std::endl
          << "Dummy2 = " << internal::has_add_local_element<Dummy2<double>> << std::endl
          << "has_set_local_element:" << std::endl
          << "Dummy = " << internal::has_set_local_element<Dummy<double>> << std::endl
          << "Dummy2 = " << internal::has_set_local_element<Dummy2<double>> << std::endl;

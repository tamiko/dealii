  ...
  for (unsigned int test = 0; test < 3; ++test)
    {
      ...
      MatrixFreeAdvection<dim, fe_degree, fe_degree + 2, double, LinearAlgebra::distributed::Vector<double>, dim> mf2(
        mf_data, true);
      ...
      for (unsigned int d = 0; d < dim; ++d)
        {
          MatrixFreeAdvection<dim, fe_degree, fe_degree + 2, double, LinearAlgebra::distributed::Vector<double>, 1> mf3(
            mf_data, true, d);
          if (d == 0)
      ...
      if (dim == 3)
        {
          MatrixFreeAdvection<dim, fe_degree, fe_degree + 2, double, LinearAlgebra::distributed::Vector<double>, 2> mf3(
            mf_data, true, 0);
          mf3.vmult(out_dist, in);
          MatrixFreeAdvection<dim, fe_degree, fe_degree + 2, double, LinearAlgebra::distributed::Vector<double>, 1> mf4(
            mf_data, true, 2);
      ...
      if (dim == 3)
        {
          MatrixFreeAdvection<dim, fe_degree, fe_degree + 2, double, LinearAlgebra::distributed::Vector<double>, 1> mf3(
            mf_data, true, 0);
          mf3.vmult(out_dist, in);
          MatrixFreeAdvection<dim, fe_degree, fe_degree + 2, double, LinearAlgebra::distributed::Vector<double>, 2> mf4(
            mf_data, true, 1);
          mf4.vmult_add(out_dist, in);

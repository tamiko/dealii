...
test(const unsigned numRefinementLevels = 2)
{
  ...
  pcout << "Periodicity constraints are consistent in parallel: " << consistent << std::endl;
  ...
  pcout << "Hanging nodes constraints are consistent in parallel: " << hanging_consistent << std::endl;

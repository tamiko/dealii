...
do_test(const FiniteElement<dim> &fe_fine, const FiniteElement<dim> &fe_coarse, const Function<dim, Number> &function)
{
  ...
  GridTools::distort_random(factor, tria_coarse, true, boost::random::mt19937::default_seed);
  ...
  GridTools::distort_random(factor, tria_fine, true, boost::random::mt19937::default_seed);

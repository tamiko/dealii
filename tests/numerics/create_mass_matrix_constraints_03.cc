...
check()
{
  ...
  MatrixTools::create_mass_matrix(mapping, dof, quadrature, matrix_ref, rhs_function, rhs_ref, &rhs_function);
  constraints.condense(matrix_ref, rhs_ref);

  MatrixTools::create_mass_matrix(mapping, dof, quadrature, matrix, rhs_function, rhs, &rhs_function, constraints);

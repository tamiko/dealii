...
main()
{
  ...
  prm.enter_subsection("section_1");
  {
    ...
    {
      prm.declare_entry("list", "default_1", Patterns::List(Patterns::Selection("default_1|b|c|d|e|f|g|h")), "docs 1");
    ...
    prm.declare_entry("some other entry with {%}", "3.1415926", Patterns::Double(), "documentation");
  }
  prm.leave_subsection();

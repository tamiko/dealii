...
{
  {
    ...
    Particles::ParticleHandler<dim, spacedim> particle_handler(tr, mapping, spacedim * spacedim);
    ...
    for (unsigned int i = 0; i < spacedim * spacedim; ++i)
      {
        ...
        data_interpretations.emplace_back(DataComponentInterpretation::component_is_part_of_tensor);
      }
    ...
    // test)
    particle_output.write_pvtu_record(deallog.get_file_stream(), {"solution-01"});
  }

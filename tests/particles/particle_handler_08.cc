...
{
  {
    ...
    for (const auto &particle : particle_handler)
      deallog << "Before refinement particle id " << particle.get_id() << " has first property "
              << particle.get_properties()[0] << " and second property " << particle.get_properties()[1] << std::endl;
    ...
    for (const auto &particle : particle_handler)
      deallog << "After refinement particle id " << particle.get_id() << " has first property "
              << particle.get_properties()[0] << " and second property " << particle.get_properties()[1] << std::endl;
    ...
    for (const auto &particle : particle_handler)
      deallog << "After coarsening particle id " << particle.get_id() << " has first property "
              << particle.get_properties()[0] << " and second property " << particle.get_properties()[1] << std::endl;
  }

  ...
  while (!discrete_time.is_at_end())
    {
      ...
      deallog << "Number of ghost particles before sort: " << std::to_string(n_ghost_particles) << std::endl;
      ...
      deallog << "Number of ghost particles after sort: " << std::to_string(n_ghost_particles) << std::endl;
      ...
      deallog << "Number of ghost particles after exchange: " << std::to_string(n_ghost_particles) << std::endl;

  ...
  if (true)
    {
      ...
      // check operators +/-, +=/-=
      deallog << "Check 7: " << (std::distance(v1.begin(), v1.begin() + 3) == 3 ? "true" : "false") << std::endl;
      deallog << "Check 8: " << (std::distance(v1.end() - 6, v1.end()) == 6 ? "true" : "false") << std::endl;
      deallog << "Check 9: " << (std::distance(v1.begin(), v1.end()) == (signed)v1.size() ? "true" : "false")
              << std::endl;
      deallog << "Check 10: " << (std::distance(v1.begin(), (v1.begin() += 7)) == 7 ? "true" : "false") << std::endl;
      deallog << "Check 11: " << (std::distance((v1.end() -= 4), v1.end()) == 4 ? "true" : "false") << std::endl;

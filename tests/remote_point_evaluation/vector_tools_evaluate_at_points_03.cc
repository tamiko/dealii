      ...
      const unsigned int                                counter)
{
  ...
  data_out.write_vtu_with_pvtu_record("./", "example-3", counter, MPI_COMM_WORLD, 1, 1);
...
test()
{
  ...
  VectorTools::interpolate(mapping_1, dof_handler_1, Functions::CosineFunction<2>(), vector_1);

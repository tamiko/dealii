...
void
d2f(const double &x, const double &y, const double &z, double &d2f_dx_dx, double &d2f_dy_dy, double &d2f_dy_dx)
{
  d2f_dx_dx = z * (6.0 * x);
  d2f_dy_dx = z * y;
  d2f_dy_dy = z * (2.0 * z + x);
...
void
d2g(const double &x, const double &y, const double &z, double &d2g_dx_dx, double &d2g_dy_dy, double &d2g_dy_dx)
{
...
void
d2h(const double &x, const double &y, const double &z, double &d2h_dx_dx, double &d2h_dy_dy, double &d2h_dy_dx)
{
  d2h_dx_dx = 2 * y * y * z;
  d2h_dy_dx = 4 * x * y * z;
  d2h_dy_dy = 2 * x * x * z;

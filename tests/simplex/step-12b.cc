...
DGMethod<dim>::assemble_system1()
{
  ...
  hp::FESubfaceValues<dim> fe_v_subface_neighbor(mapping, fe, face_quadrature_dummy, neighbor_face_update_flags);
                  ...
                  for (unsigned int subface_no = 0; subface_no < face->n_children(); ++subface_no)
                    {
                      ...
                      dg.assemble_face_term1(fe_v_subface, fe_v_face_neighbor, ui_vi_matrix, ue_vi_matrix);
                  ...
                  if (neighbor->level() == cell->level())
                    {
                      ...
                      dg.assemble_face_term1(fe_v_face, fe_v_face_neighbor, ui_vi_matrix, ue_vi_matrix);
                    }
                  else
                    {
                      ...
                      dg.assemble_face_term1(fe_v_face, fe_v_subface_neighbor, ui_vi_matrix, ue_vi_matrix);
                    }

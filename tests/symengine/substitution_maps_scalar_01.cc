...
main()
{
  ...
  SD::add_to_substitution_map(substitution_map, std::make_pair(SD::Expression("x11"), 11));
  SD::add_to_substitution_map(substitution_map,
                              std::vector<std::pair<SD::Expression, int>>{std::make_pair(SD::Expression("x12"), 12),
  ...
  try
    {
      SD::add_to_substitution_map(substitution_map, std::make_pair(SD::Expression("x14"), 14));

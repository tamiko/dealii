...
main()
{
  ...
  SD::add_to_substitution_map(substitution_map, SD::make_tensor_of_symbols<2, dim>("t1"), t);
  SD::add_to_substitution_map(substitution_map, SD::make_symmetric_tensor_of_symbols<2, dim>("st1"), st);

              ...
              for (unsigned int l = 0; l < dim; ++l)
                {
                  ...
                  change_with_brackets[indices]    = entry;
                  change_with_parentheses(indices) = entry;
                  AssertThrow(change_with_brackets[i][j][k][l] == entry, ExcMessage("Entries should match"));
                  AssertThrow(change_with_parentheses[i][j][k][l] == entry, ExcMessage("Entries should match"));

...
main()
{
  ...
  // test nested reordering:
  {
    TensorAccessors::internal::
      ReorderedIndexView<0, 9, TensorAccessors::internal::ReorderedIndexView<4, 9, Tensor<9, 3, int>>> // auto ...
...

  {
    ...
    TensorAccessors::internal::
      ReorderedIndexView<1, 3, TensorAccessors::internal::ReorderedIndexView<0, 3, Tensor<3, 2, int>>> // auto ...
        foo102 = TensorAccessors::reordered_index_view<1, 3>(foo120);
    PRINTME(foo102);

    deallog << "Order of indices 2 0 1  -->  ";
    TensorAccessors::internal::
      ReorderedIndexView<0, 3, TensorAccessors::internal::ReorderedIndexView<0, 3, Tensor<3, 2, int>>> // auto ...
        foo201 = TensorAccessors::reordered_index_view<0, 3>(foo120);
    PRINTME(foo201);

    deallog << "Order of indices 2 1 0  -->  ";
    TensorAccessors::internal::
      ReorderedIndexView<0, 3, TensorAccessors::internal::ReorderedIndexView<1, 3, Tensor<3, 2, int>>> // auto ...
...

  {
    ...
    dealii::TensorAccessors::internal::ReorderedIndexView<2, 5, const double[3][3][3][3][3]> // auto ...

...
void
test(LinearAlgebra::EpetraWrappers::Vector &v, LinearAlgebra::EpetraWrappers::Vector &w)
{
...
main(int argc, char **argv)
{
  ...
  try
    {
      {
        LinearAlgebra::EpetraWrappers::Vector v(complete_index_set(100), MPI_COMM_SELF);
        LinearAlgebra::EpetraWrappers::Vector w(complete_index_set(95), MPI_COMM_SELF);
        test(v, w);
      }
    }
